...
/**
 * Controller for serving photo files from PostgreSQL database binary storage
 */
@Controller
...
public class PhotoFileController {
    ...
    /**
     * Serves a photo file by ID from PostgreSQL database binary storage
     */
    @GetMapping("/{id}")
    public ResponseEntity<Resource> servePhoto(@PathVariable String id) {
        ...
        try {
            ...
            // Get photo data from PostgreSQL database binary storage
