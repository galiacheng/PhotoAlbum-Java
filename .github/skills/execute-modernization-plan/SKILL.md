...
1. Read ${modernization-work-folder}/plan.md and ${modernization-work-folder}/clarifications.json, you can have an overview with the modernization plan. You must reconcile the tasks to ensure they align with the plan.md. If there are any discrepancies, call skill reconcile-tasks-with-plan to update the tasks.json before you start any task.
