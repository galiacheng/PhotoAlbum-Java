# Upgrade Progress
  ...
  - ###
    ...
    #### CVE issues
    - Dependency `commons-io:commons-io` has **1** known CVEs:
  ...
  - ###
    ...
    #### Recipes
    - [org.openrewrite.java.spring.boot3.UpgradeSpringBoot_3_3](https://docs.openrewrite.org/recipes/java/spring/boot3/upgradespringboot_3_3)
    ...
    - Applied OpenRewrite recipe org.openrewrite.java.spring.boot3.UpgradeSpringBoot_3_3
      - Upgraded Spring Boot dependencies to 3.3.x
      - Migrated deprecated Spring Boot 2.x APIs to Spring Boot 3.x equivalents
    - Applied OpenRewrite recipe org.openrewrite.java.migrate.UpgradeToJava17
      - Updated Java source and target compatibility to Java 17
      - Migrated deprecated Java APIs to Java 17 equivalents
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgraded Spring Boot parent version from 3.3.13 to 3.4.3
      - Updated spring-boot-starter-parent in pom.xml to version 3.4.3
    </details>
  ...
  - ###
    ### ✅ Upgrade using Agent [View Log](logs\7.1.upgradeProjectUsingAgent.log)
    1 file changed, 1 insertion(+), 1 deletion(-)
    <details>
        <summary>[ click to toggle details ]</summary>
    
    #### Code changes
    - Upgraded Spring Boot parent version from 3.4.3 to 3.5.5
      - Updated spring-boot-starter-parent in pom.xml to version 3.5.5
    </details>
  
    ### ✅ Build Project [View Log](logs\7.2.buildProject.log)
    Build result: 100% Java files compiled
    <details>
        <summary>[ click to toggle details ]</summary>
  ...
  - ###
    ...
    #### Checked Dependencies
      - org.springframework.boot:spring-boot-starter-web:3.5.5:jar
      - org.springframework.boot:spring-boot-starter-thymeleaf:3.5.5:jar
      - org.springframework.boot:spring-boot-starter-data-jpa:3.5.5:jar
      - com.oracle.database.jdbc:ojdbc8:23.7.0.25.01:jar
      - org.springframework.boot:spring-boot-starter-validation:3.5.5:jar
      - org.springframework.boot:spring-boot-starter-json:3.5.5:jar
      - org.springframework.boot:spring-boot-starter-test:3.5.5:jar
      - com.h2database:h2:2.3.232:jar
      - org.springframework.boot:spring-boot-devtools:3.5.5:jar
      - java:*:17
    </details>
  
    ### ✅ Validate And Fix Code Behavior Changes [View Log](logs\8.2.validateBehaviorChanges.log)
