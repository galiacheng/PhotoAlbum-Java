# Upgrade Progress
  ...
  - ###
    ...
    - Migrate javax.* to jakarta.*
      ...
      - PhotoServiceImpl.java and controllers: updated imports as needed by OpenRewrite
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.3.13 to 3.4.7
      - Updated spring-boot-starter-parent version from 3.3.13 to 3.4.7 in pom.xml
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.4.7 to 3.5.3
      - Updated spring-boot-starter-parent version from 3.4.7 to 3.5.3 in pom.xml
    </details>
  ...
  - ###
    ...
    #### Checked Dependencies
      - org.springframework.boot:spring-boot-starter-web:3.5.3:jar
      - org.springframework.boot:spring-boot-starter-thymeleaf:3.5.3:jar
      - org.springframework.boot:spring-boot-starter-data-jpa:3.5.3:jar
      - com.oracle.database.jdbc:ojdbc8:23.7.0.25.01:jar
      - org.springframework.boot:spring-boot-starter-validation:3.5.3:jar
      - org.springframework.boot:spring-boot-starter-json:3.5.3:jar
      - org.springframework.boot:spring-boot-starter-test:3.5.3:jar
      - com.h2database:h2:2.3.232:jar
      - org.springframework.boot:spring-boot-devtools:3.5.3:jar
      - java:*:21
    </details>
