# Upgrade Progress
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.3.13 to 3.4.9
      - Updated spring-boot-starter-parent version in pom.xml to 3.4.9
    </details>
  ...
  - ###
    ### ✅ Upgrade using Agent
    - [[View Log]](logs\8.1.upgradeProjectUsingAgent.log)
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.4.9 to 3.5.9
      - Updated spring-boot-starter-parent version in pom.xml to 3.5.9
    </details>
  ...
  - ###
    ...
    #### Checked Dependencies
      - org.springframework.boot:spring-boot-starter-web:3.5.9:jar
      - org.springframework.boot:spring-boot-starter-thymeleaf:3.5.9:jar
      - org.springframework.boot:spring-boot-starter-data-jpa:3.5.9:jar
      - com.oracle.database.jdbc:ojdbc8:23.7.0.25.01:jar
      - org.springframework.boot:spring-boot-starter-validation:3.5.9:jar
      - org.springframework.boot:spring-boot-starter-json:3.5.9:jar
      - org.springframework.boot:spring-boot-starter-test:3.5.9:jar
      - com.h2database:h2:2.3.232:jar
      - org.springframework.boot:spring-boot-devtools:3.5.9:jar
      - java:*:21
    </details>
