# Upgrade Progress
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 2.7.18 to 3.3.13 and Java from 8 to 17
      - Upgraded Spring Boot parent version to 3.3.13 in pom.xml
      - Updated Java version properties to 17
      - Migrated javax.* imports to jakarta.* (persistence, validation)
      - Applied OpenRewrite recipes for Spring Boot 3.3 and Java 17 migration
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.3.13 to 3.4.6
      - Updated Spring Boot parent version to 3.4.6 in pom.xml
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.4.6 to 3.5.0
      - Updated Spring Boot parent version to 3.5.0 in pom.xml
    </details>
  ...
  - ###
    ...
    #### Checked Dependencies
      ...
      - org.springframework.boot:spring-boot-starter-thymeleaf:3.5.0:jar
      ...
      - org.springframework.boot:spring-boot-starter-json:3.5.0:jar
      - org.springframework.boot:spring-boot-starter-test:3.5.0:jar
      - com.h2database:h2:2.3.232:jar
      - org.springframework.boot:spring-boot-devtools:3.5.0:jar
      - java:*:17
    </details>
