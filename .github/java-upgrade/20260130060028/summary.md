...
All code changes have been committed to branch `003-modernization-plan`, here are the details:
6 files changed, 14 insertions(+), 14 deletions(-)

- ac6a87b -- Upgrade project to use `Spring Boot 3.3.x`, `Java 17` using openrewrite.

- 7b301d5 -- Upgrade Spring Boot from 3.3.13 to 3.4.6

- 27c802e -- Upgrade Spring Boot from 3.4.6 to 3.5.0
### Potential Issues
