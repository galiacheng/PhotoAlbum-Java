# Upgrade Progress
  ...
  ### ✅ Upgrade project to use `Spring Boot 3.3.x`
  ...
  - ###
    ...
    - Migrate JavaEE (javax.*) to Jakarta EE (jakarta.*)
      - Updated imports in Photo.java from javax.persistence.* to jakarta.persistence.*
      - Updated imports in Photo.java from javax.validation.constraints.* to jakarta.validation.constraints.*
    - Update controller parameter annotation
      - Simplified @RequestParam annotation in HomeController.uploadPhotos method
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.3.13 to 3.4.3
      - Updated spring-boot-starter-parent version in pom.xml
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.4.3 to 3.5.0
      - Updated spring-boot-starter-parent version in pom.xml
    </details>
