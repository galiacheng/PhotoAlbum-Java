# Upgrade Progress
  ...
  - ###
    ...
    #### Code changes
    - Apply org.openrewrite.java.spring.boot3.UpgradeSpringBoot_3_3 recipe
      - Upgrade Spring Boot dependencies to 3.3.x
      - Migrate from javax.* to jakarta.* packages
    - Apply org.openrewrite.java.migrate.UpgradeToJava17 recipe
      - Update Java version to 17
      - Apply Java 17 compatibility changes
    </details>
  ...
  - ###
    ...
    - Upgrade Spring Boot to 3.4.3
      - Updated parent version from 3.3.13 to 3.4.3
    </details>
  ...
  - ###
    ...
    - Upgrade Spring Boot to 3.5.7
      - Updated parent version from 3.4.3 to 3.5.7
    </details>
  ...
  - ###
    ...
    #### Checked Dependencies
      - org.springframework.boot:spring-boot-starter-web:3.5.7:jar
      - org.springframework.boot:spring-boot-starter-thymeleaf:3.5.7:jar
      - org.springframework.boot:spring-boot-starter-data-jpa:3.5.7:jar
      - com.oracle.database.jdbc:ojdbc8:23.7.0.25.01:jar
      - org.springframework.boot:spring-boot-starter-validation:3.5.7:jar
      - org.springframework.boot:spring-boot-starter-json:3.5.7:jar
      - org.springframework.boot:spring-boot-starter-test:3.5.7:jar
      - com.h2database:h2:2.3.232:jar
      - org.springframework.boot:spring-boot-devtools:3.5.7:jar
      - java:*:17
    </details>
