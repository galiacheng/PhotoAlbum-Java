# Upgrade Progress
  ...
  - ###
    ...
    #### Code changes
    - Applied OpenRewrite transformation for Spring Boot 3.3.x upgrade
      - Applied recipe org.openrewrite.java.spring.boot3.UpgradeSpringBoot_3_3
    - Applied OpenRewrite transformation for Java 17 upgrade
      - Applied recipe org.openrewrite.java.migrate.UpgradeToJava17
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgraded Spring Boot version from 3.3.13 to 3.4.3
      - Updated parent dependency version in pom.xml
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgraded Spring Boot version from 3.4.3 to 3.5.0
      - Updated parent dependency version in pom.xml
    </details>
