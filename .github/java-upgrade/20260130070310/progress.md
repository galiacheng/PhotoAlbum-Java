# Upgrade Progress
  ...
  - ###
    ...
    #### Code changes
    - Apply OpenRewrite recipes for Spring Boot 3.3 and Java 17 upgrade
      - Applied org.openrewrite.java.spring.boot3.UpgradeSpringBoot_3_3 recipe
      - Applied org.openrewrite.java.migrate.UpgradeToJava17 recipe
      - Migrate from javax.* to jakarta.* namespace
      - Update Spring Boot version to 3.3.x
  ...
  - ###
    ...
    - Upgrade Spring Boot to 3.4.3
      - Updated spring-boot-starter-parent version from 3.3.13 to 3.4.3
    </details>
  ...
  - ###
    ...
    - Upgrade Spring Boot to 3.5.0
      - Updated spring-boot-starter-parent version from 3.4.3 to 3.5.0
    </details>
