# Upgrade Progress
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Java version from 8 to 17
      - Updated pom.xml java.version, maven.compiler.source, and maven.compiler.target to 17
      - Applied OpenRewrite recipe org.openrewrite.java.migrate.UpgradeToJava17 for code migration
    </details>
