# Upgrade Progress
  ...
  - ###
    ...
    - Upgrade Java version to 17
      - Update pom.xml to set java.version, maven.compiler.source, and maven.compiler.target to 17
      - Applied OpenRewrite recipe org.openrewrite.java.migrate.UpgradeToJava17 to make necessary code changes
    </details>
